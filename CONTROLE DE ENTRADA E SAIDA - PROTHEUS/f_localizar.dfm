object frm_localizar: Tfrm_localizar
  Left = 0
  Top = 0
  Align = alClient
  BorderIcons = []
  ...
  object dbg_busca: TcxGrid
    ...
    Align = alClient
    TabOrder = 1
    object dbg_buscaDBTableView1: TcxGridDBTableView
      OnKeyPress = dbg_buscaDBTableView1KeyPress
      Navigator.Buttons.CustomButtons = <>
      FindPanel.DisplayMode = fpdmAlways
      FindPanel.InfoText = 'Entre com o texto para Buscar'
      OnCellDblClick = dbg_buscaDBTableView1CellDblClick
      OnEditKeyPress = dbg_buscaDBTableView1EditKeyPress
    ...
    object dbg_buscaLevel1: TcxGridLevel
      GridView = dbg_buscaDBTableView1
    end
  end
